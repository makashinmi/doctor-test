...
- **storage** (dict) — хранилище, являющееся поверхностной копией атрибута **storage** родительского объекта
...
#### **commit()**
Переписывает атрибут **storage** родительского объекта **parent** на собственный **storage**
